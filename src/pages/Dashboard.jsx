    ...
    <TabContext value={value}>
      <div className='header'>
        <div className='Infos'>
          <div className='infoAtraso'>
            <MdAttachMoney className='iconsTop'/>
            <div className='subInfo'>
              <p className='debitos'>Debitos em Atraso</p>
              <h3 className='valorDebitos'>R$0,00</h3>
            </div>
          </div>
        </div>
        <div className='Infos'>
          <div className='infoAtraso'>
            <BiSpreadsheet className='iconPlan'/>
            <div className='subInfo'>
      ...
      <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
        <TabList onChange={handleChange} aria-label="lab API tabs example">
          <Tab label="Graficos" value="1" />
          <Tab label="Relatorios" value="2" />
          <Tab label="Terceira aba" value="3" />
        </TabList>
      </Box>
      <TabPanel value="1">
