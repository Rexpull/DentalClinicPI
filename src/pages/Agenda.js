        ...
        <Paper className="papers">
          <Scheduler data={data} height={680} locale="pt-BR">
            ...
            <AppointmentTooltip
              ...
              showCloseButton
              showDeleteButton
              onOpenButtonClick={() => this.onEditingAppointmentChange(appointment)}
            />
            <Toolbar />
            ...
            {({ TransitionProps }) => (
              <Fade {...TransitionProps} timeout={350} >
                <Paper  sx={{minWidth:'500px'}}>
                  ...
                  <Divider></Divider>
                  <div style={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center',paddingTop:40,paddingBottom:40,}}>
